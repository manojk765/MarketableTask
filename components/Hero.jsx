...
export default function HeroSection() {
  ...
  return (
    <div className="relative min-h-screen bg-[#001F54] overflow-hidden">  {/* Primary color */}
  <DynamicMoneyScene />
  <div className="container relative mx-auto px-10 py-10 sm:py-12">
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
      ...
      >
        ...
        <p className="max-w-[600px] text-[#F5F5F5] md:text-xl mx-auto lg:mx-0">  {/* Secondary color */}
          Experience the next generation of financial technology...
        </p>
        <div className="mt-8 flex flex-wrap gap-4 justify-center lg:justify-start">
          <Button
            size="lg"
            className="bg-[#00D084] hover:bg-[#00D084]/80 text-white"   
          >
            Get Started
          </Button>
          <Button
            size="lg"
            variant="outline"
            className="border-[#00D084] text-[#00D084] hover:bg-[#00D084]/10"
          >
            Watch Demo
          </Button>
        </div>
      ...
      >
        <div className="relative aspect-square max-w-md mx-auto">
          <div className="absolute inset-0 bg-gradient-to-r from-[#00D084] to-[#00D084]/80 rounded-full blur-3xl opacity-20 animate-pulse" />
          <Image
