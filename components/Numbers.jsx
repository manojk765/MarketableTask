...
export default function NumberSection() {
    ...
    return (
        <section className="mx-auto relative text-white mt-40 flex justify-center bg-[#1a1a2e]">
            <header
            ...
            <motion.section
                ...
                animate={isVisible ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }} // Animation based on visibility
